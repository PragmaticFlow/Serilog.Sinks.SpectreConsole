...
var solution = File("./Serilog.Sinks.SpectreConsole.sln");
var project = File("./src/Serilog.Sinks.SpectreConsole/Serilog.Sinks.SpectreConsole.fsproj");
...
Task("Build")
    ...
    .Does(() =>
{
    Information("Serilog.Sinks.SpectreConsole Version: {0}", version);
